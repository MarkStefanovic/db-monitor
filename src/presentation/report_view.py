...
class ReportView(qtw.QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._search_box.textChanged.connect(self._on_search_box_text_changed)  # noqa
        ...
        self._refresh_button.clicked.connect(self._on_refresh_button_clicked)  # noqa
        ...
        self._view_model.modelReset.connect(self._table_view.resizeColumnsToContents)  # noqa
